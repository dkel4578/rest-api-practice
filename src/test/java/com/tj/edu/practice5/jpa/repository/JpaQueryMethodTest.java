...
//
//        List<Member> memberList10 = memberRepository.findByNameStartingWith("홍");
//        memberList10.forEach(s -> System.out.println(s));
//
//        List<Member> memberList11 = memberRepository.findByNameEndingWith("순");
//        memberList11.forEach(s -> System.out.println(s));
//
//        List<Member> memberList12 = memberRepository.findByNameOrderByIdDesc("홍길동");
