...
public class ApiControllerAdvice {
    ...
    public ResponseEntity arithmeticException(ArithmeticException ae) {
    ...
    public ResponseEntity methodArgumentNotValidException(MissingServletRequestParameterException manve) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("(advice) age 값을 넣어서 보내주세요.");
    }
}
